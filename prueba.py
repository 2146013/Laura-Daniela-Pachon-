#!/usr/bin/env python
# coding: utf-8
#imprimir de forma a+bi
#exponencial
#complejo elevado a la n (n es un entero)
"""
...
def division(c_1,c_2):
    ...
    (lista de longitud 2) correspondinte a la operacion c_1 / c_2.
    """
    conjuga = conjugado(c_2)
    divisor=producto(c_1,conjuga)
    dividendo= producto(c_2,conjuga)
    if dividendo[0] != 0 :
...
# Justificación de la prueba :
# $$ (3-2i) / (5+4i) = ((3-2i) / (5+4i))*((5-4i) / (5-4i)) = (7/41)-(22i/41)$$ 
